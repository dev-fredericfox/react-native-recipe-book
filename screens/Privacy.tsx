...
type NavProp = NativeStackScreenProps<RootStackParamList, "Privacy">;

export default function Privacy({ navigation }: NavProp) {
  return (
    <ScrollView style={tw`flex-initial bg-slate-100 px-4`}>
      <Text style={tw`text-xl`}>Datenschutz&shy;erkl&auml;rung</Text>
      <Text style={tw`text-lg`}>1. Datenschutz auf einen Blick</Text>
      <Text>Allgemeine Hinweise</Text>
      <Text>
      ...
      <Text>Datenerfassung auf dieser Website</Text>
      <Text>Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</Text>
      <Text>
      ...
      <Text style={tw`text-lg`}>2. Hosting</Text>
      <Text>Externes Hosting</Text>
      <Text>
      ...
      <Text>Wir setzen folgenden Hoster ein:</Text>
      <Text>Vercel Inc.</Text>
      <Text>330 S Lemon Ave #4133 Walnut</Text>
      <Text>CA 91789 United States</Text>
      <Text style={tw`text-lg`}>3. Allgemeine Hinweise und Pflicht&shy;informationen</Text>
      ...
      <Text>
        ...
        erheben und wof&uuml;r wir sie nutzen. Sie erl&auml;utert auch, wie und zu welchem
        Zweck das geschieht.
      </Text>
      <Text>
      ...
      <Text>Hinweis zur verantwortlichen Stelle</Text>
      <Text>
        Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:
      </Text>
      <Text>Frederic Fox Hintere Dorfstr. 6</Text>
      <Text>Telefon: 016092201612 E-Mail: dev.frederic.fox@gmail.com</Text>
      <Text>
      ...
      <Text>
        ...
        HABEN SIE JEDERZEIT DAS RECHT, AUS GR&Uuml;NDEN, DIE SICH AUS IHRER BESONDEREN
        SITUATION ERGEBEN, GEGEN DIE VERARBEITUNG IHRER PERSONENBEZOGENEN DATEN WIDERSPRUCH
        EINZULEGEN; DIES GILT AUCH F&Uuml;R EIN AUF DIESE BESTIMMUNGEN GEST&Uuml;TZTES
      ...
      <Text>Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</Text>
      <Text>
      ...
      <Text>Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</Text>
      <Text>
      ...
      <Text>SSL- bzw. TLS-Verschl&uuml;sselung</Text>
      <Text>
        ...
        von &bdquo;http://&ldquo; auf &bdquo;https://&ldquo; wechselt und an dem Schloss-Symbol
      ...
      <Text>Auskunft, L&ouml;schung und Berichtigung</Text>
      <Text>
      ...
      <Text>Recht auf Einschr&auml;nkung der Verarbeitung</Text>
      <Text>
      ...
      <Text>
        Quelle: <Anchor href="https://www.google.com">Bob</Anchor>
      </Text>
    </ScrollView>
  );
}
